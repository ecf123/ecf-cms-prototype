  ...
  return (
    <div className="pathway-display">
        <div className="pathway-display__container">
          <img className="pathway-display__option" id="grid-icon" src={grid} alt="grid display option"/>
          <img className="pathway-display__option" src ={hamburger} alt="list view option"/>
        </div>
