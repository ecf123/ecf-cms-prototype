...
it("Should display the freeType content, shortPlaceholderText and shortLabelText", () => {
    render(<AddLessonAdditionalBoxes freeTypeLabelText="Additional Content (optional)" shortPlaceHolderText="e.g. Fund Manager" shortLabelText="Additional Subtitle(s) (optional)"/>);
