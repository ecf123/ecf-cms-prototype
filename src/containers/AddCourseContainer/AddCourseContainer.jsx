...
const AddCourseContainer = () => {
  ...
  const classNameInputTwo =
    (pageInfo.shortInputTwo != "" && !pageFirstOpened) || pageFirstOpened
      ? "short__input"
      : "short__input--empty";

  const classNameInput =
    (pageInfo.shortInputOne != "" && !pageFirstOpened) || pageFirstOpened
      ? "short__input"
      : "short__input--empty";

  const classNameInputThree =
    (pageInfo.freeTypeInputOne != "" && !pageFirstOpened) || pageFirstOpened
      ? "free-type__input"
